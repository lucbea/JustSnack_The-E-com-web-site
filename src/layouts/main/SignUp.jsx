...
export default function SignUp() {
  ...
  const handleSubmitRegister = async (event) => {
    ...
    // Obtener los usuarios registrados desde Firebase
    ...
    console.log("SIGN UP - local storage - user:", user)
    // Guardar el usuario actual en localStorage
    // localStorage.setItem('usuarioActual', JSON.stringify(userReg.userId));
