...
export const PagoCompra = () => {
    ...
    const cierreVentana = () => {
        console.log("estoy en cierreVentana");
        navigate(`/`);
        setOrdenCarro([]);
        setTotalCarro(0);
        // setCantItems(0);
    ...
    return (
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', minHeight:'70vh'}}>
            <Box onClick={() => cierreVentana()} sx={{ cursor: 'pointer', width: '90vw', height: '60vh', backgroundColor: theme.palette.modal.blanco, maxWidth: '800px', boxShadow: theme.palette.primary.sombra, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '30px', margin: 'auto' }}>
